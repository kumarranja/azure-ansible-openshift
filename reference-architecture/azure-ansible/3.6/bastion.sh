...
export SSHPUBLICDATA3=${12}
export REGISTRYSTORAGENAME=${array[13]}
export REGISTRYKEY=${array[14]}
export LOCATION=${array[15]}
export SUBSCRIPTIONID=${array[16]}
export TENANTID=${array[17]}
export AADCLIENTID=${array[18]}
export AADCLIENTSECRET=${array[19]}
export RHSMMODE=${array[20]}
export OPENSHIFTSDN=${array[21]}
export METRICS=${array[22]}
export LOGGING=${array[23]}
export OPSLOGGING=${array[24]}
export GITURL=${array[25]}
